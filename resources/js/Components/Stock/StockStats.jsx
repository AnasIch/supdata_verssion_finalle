...
const statItems = [
    { key: "total", label: "Produits", icon: Package, color: "bg-blue-50 text-blue-600" },
    { key: "critical", label: "Produits critiques", icon: AlertTriangle, color: "bg-amber-50 text-amber-600" },

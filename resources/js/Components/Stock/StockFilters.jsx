...
import { categoryOptions as defaultCategoryOptions, statusOptions } from "@/Mocks/stock";

export default function StockFilters({ filters, categories, onFilterChange, onReset }) {
    const categoryList = categories
        ? [{ value: "all", label: "Toutes les catégories" }, ...categories.map((c) => ({ value: c, label: c }))]

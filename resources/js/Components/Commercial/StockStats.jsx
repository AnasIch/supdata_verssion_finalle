...
const stats = [
    ...
    { key: "available", label: "Disponibles", icon: CheckCircle2, color: "bg-emerald-50 text-emerald-600" },
    { key: "low", label: "Stock faible", icon: AlertTriangle, color: "bg-amber-50 text-amber-600" },
    { key: "outOfStock", label: "Rupture", icon: XCircle, color: "bg-red-50 text-red-500" },
];

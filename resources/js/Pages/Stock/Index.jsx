...
export default function StockIndex() {
    ...
    const handleView = (product) => {
        window.location.href = `${getDashboardPath(user.role)}/stock/${product.id}`;
    };
            ...
            <div className="flex flex-col gap-6">
                ...
                >
                    <PageTitle
                        ...
                        description="Consultez et gérez l'ensemble des équipements et produits."
                    />
                </motion.div>
                ...
                <div className="hidden sm:block">
                    <StockTable data={paged} onView={handleView} />
                </div>

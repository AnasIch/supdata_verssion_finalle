...
export default function StockOperations({ section, initialItems, products, categories, user: routeUser }) {
    const operations = useStockOperations(section, initialItems, { products, categories });

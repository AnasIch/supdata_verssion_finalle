...
<head>
    ...
    <title>Réservation annulée — SUPDATA ERP</title>
</head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 560px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                ...
                <tr>
                    <td style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 32px 40px; text-align: center;">
                        ...
                        <p style="margin: 6px 0 0; color: #94a3b8; font-size: 13px;">Réservation annulée</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 36px 40px 20px;">
                        ...
                        <p style="margin: 0 0 28px; color: #475569; font-size: 14px; line-height: 1.7;">
                            Votre réservation <strong>{{ $reservation->reference }}</strong> a été annulée par le Responsable Stock <strong>{{ $actor->name }}</strong>.
                        </p>
                            ...
                            <tr>
                                <td style="padding: 24px 28px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding: 8px 0; color: #64748b; font-size: 13px;">Annulée par</td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 12px; margin-bottom: 28px;">
                            <tr>
                                <td style="padding: 20px 24px;">
                                    <p style="margin: 0 0 8px; color: #991b1b; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Motif de l'annulation</p>
                                    <p style="margin: 0; color: #b91c1c; font-size: 14px; line-height: 1.6;">{{ $reason }}</p>
                                </td>
                            </tr>
                        </table>
                    </td>

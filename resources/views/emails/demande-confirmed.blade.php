...
<head>
    ...
    <title>Votre demande a été approuvée — SUPDATA ERP</title>
</head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 560px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
                ...
                <tr>
                    <td style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 32px 40px; text-align: center;">
                        ...
                        <p style="margin: 6px 0 0; color: #94a3b8; font-size: 13px;">Votre demande a été approuvée</p>
                    </td>
                </tr>

                <tr>
                    <td style="padding: 36px 40px 20px;">
                        <p style="margin: 0 0 20px; color: #334155; font-size: 15px; line-height: 1.6;">Bonjour {{ $demande->user->name ?? '' }},</p>
                        <p style="margin: 0 0 28px; color: #475569; font-size: 14px; line-height: 1.7;">
                            Votre demande <strong>{{ $demande->title }}</strong> a été validée par l'Administrateur Local <strong>{{ $actor->name }}</strong>.
                            <br><br>
                            Elle est maintenant transmise au Responsable Stock.
                        </p>
                            ...
                            <tr>
                                <td style="padding: 24px 28px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding: 8px 0; color: #64748b; font-size: 13px; width: 140px;">Titre</td>
                                        ...
                                        <tr>
                                            <td style="padding: 8px 0; color: #64748b; font-size: 13px;">Confirmé par</td>
                            ...
                            <tr>
                                <td style="padding: 16px 20px;">
                                    <p style="margin: 0; color: #1e40af; font-size: 13px; line-height: 1.6;">
                                        <strong>Information :</strong> Cette demande a été confirmée par l'Administrateur Local. Elle est maintenant transmise au Responsable Stock pour traitement.
                                    </p>
                                </td>
                            </tr>
                        </table>
